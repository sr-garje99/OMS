                   ...
                   <Card className="m-3 rounded shadow-lg main-order-show" style={{ width: '22rem' }}>
										<div className="full-order-detail">
											<Card.Body>
												...
												<Card.Text> add new Order</Card.Text>
                        
                          <Link className="btn btn-outline-primary mr-2" to={`/addorder`}>
                              Add Order
                          </Link>
                          <hr/>
                          <Card.Title>Add Admin</Card.Title>
												<Card.Text> add admin user</Card.Text>
                        <Link style={{width:'',height:'inherit',float:'centre'}}className="btn btn-outline-primary mr-2" to={`/addUser`}>
									Add Admin
								</Link>
